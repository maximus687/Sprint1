...
class DataHandler {
	...
	public static List<Screen> getListOfScreens() {
		...
		listOfScreens.add(new Screen(102001, 2001, "Screen1", LocalDate.parse("2019-09-30"), getlistOfShows(), 25, 20));
		listOfScreens.add(new Screen(112001, 2001, "Screen2", LocalDate.parse("2019-09-25"), getlistOfShows(), 25, 20));
		listOfScreens.add(new Screen(102002, 2002, "Screen1", LocalDate.parse("2019-09-20"), getlistOfShows(), 25, 20));
		listOfScreens.add(new Screen(112002, 2002, "Screen2", LocalDate.parse("2019-09-30"), getlistOfShows(), 25, 20));
		listOfScreens.add(new Screen(102003, 2003, "Screen1", LocalDate.parse("2019-09-26"), getlistOfShows(), 25, 20));
		listOfScreens.add(new Screen(112003, 2003, "Screen2", LocalDate.parse("2019-09-27"), getlistOfShows(), 25, 20));
		listOfScreens.add(new Screen(122003, 2003, "Screen3", LocalDate.parse("2019-09-28"), getlistOfShows(), 25, 20));
	...
	public static List<Show> getlistOfShows() {
		...
		listOfShows.add(new Show(4001, LocalTime.of(8, 12, 00), LocalTime.of(10, 00, 12), seat, "Morning Show", " War"));
		listOfShows.add(new Show(4002, LocalTime.of(12, 12, 00), LocalTime.of(2, 00, 12), seat, "Afternoon Show", " War"));
		listOfShows.add(new Show(4003, LocalTime.of(4, 12, 00), LocalTime.of(6, 00, 12), seat, "Evenng Show", " War"));
		listOfShows.add(new Show(4004, LocalTime.of(9, 12, 00), LocalTime.of(11, 00, 12), seat, "Late Night Show", " War"));
		return listOfShows;
	}
